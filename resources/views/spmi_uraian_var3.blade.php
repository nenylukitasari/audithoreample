...
@section('title-bar')
  ...
  @foreach ($version->kegiatan as $kegiatan)
    @if($kegiatan->kode_bagian==11)
    @foreach($kegiatan->kategori as $kategori)
    @if($kategori->kode_bagian == 27)
...
@foreach ($version->kegiatan as $kegiatan)
@if($kegiatan->kode_bagian==11)
  <li class="active"><a href="/data/2/11">{{$kegiatan->nama_kegiatan}}</a></li>
  @foreach($kegiatan->kategori as $kategori)
    @if($kategori->kode_bagian == 27)
            ...
            <div class="box-body">
              <table border="0">
                ...
                <tr>
                  ...
                  <td width="10">:</td>
                  <td>
                  <input type="number" class="form-control" id="edit_var1" name="edit_var1" placeholder="Juara I" required>
                  </td>
                </tr>
                <tr>
                  <th class="col-sm-3 control-label">Juara II</th>
                  <td width="10">:</td>
                  <td>
                  <input type="number" class="form-control" id="edit_var2" name="edit_var2" placeholder="Juara II" required>
                  </td>
                </tr>
                <tr>
                  <th class="col-sm-3 control-label">Juara III</th>
                  <td width="10">:</td>
                  <td>
                  <input type="number" class="form-control" id="edit_var3" name="edit_var3" placeholder="Juara III" required>
                  </td>
                </tr>
                <tr>
                  <th class="col-sm-3 control-label">Satuan</th>
